...
For the purposes of this Privacy Policy:
  ...
  * Website refers to Hankou, accessible from <https://www.hankou.com/>
...
We use both Session and Persistent Cookies for the purposes set out below:
  ...
  * Advertising Cookies
    ...
    Purpose: Our website displays advertisements served by Google and other third-party vendors. These cookies are used to serve ads based on a user's prior visits to our Website or other websites on the Internet.

    Third-party vendors, including Google, use cookies to serve personalized ads.

    Google's use of advertising cookies enables it and its partners to serve ads to our users based on their visit to our Service and/or other sites on the Internet.

    Users may opt out of personalized advertising by visiting Google's Ads Settings page: https://www.google.com/settings/ads.

    Alternatively, users can opt out of a third-party vendor's use of cookies for personalized advertising by visiting https://www.aboutads.info/choices/.
...
We have no control over and assume no responsibility for the content, privacy policies or practices of any third party sites or services. This includes links provided by our third-party advertising partners, such as Google AdSense.
